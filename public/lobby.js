...
document.querySelectorAll("[data-game]").forEach(btn=>btn.onclick=()=>{
  ...
  const o=selectedGame==="okey", g=selectedGame==="olympus";
  document.getElementById("selectedIcon").textContent=g?"⚡":o?"🀄":"♠";
  document.getElementById("selectedTitle").textContent=g?"OLYMPUS STORM":o?"101 OKEY":"BLACKJACK";
  document.getElementById("selectedDesc").textContent=g?"6×5 taklalı demo slot oyunu":o?"4 kişilik online 101 Okey masası":"5 kişiye kadar online Blackjack masası";
...
document.getElementById("enterGame").onclick=()=>{
  ...
  location.href=selectedGame==="okey"?"/okey.html":selectedGame==="olympus"?"/olympus.html":"/blackjack.html";
};
